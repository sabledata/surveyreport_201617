...
The 2018 survey of `r setcnt` sets was chartered aboard the 35.66 meter F/V `r boat`, skippered by `r captain`  and Mike Derry between `r dates`, `r yr`. The `r yr+1` survey of `r setcnt2` sets was chartered aboard the 25.34 meter F/V `r boat2`, skippered by Albert (Deacon) Melnychuk between `r dates2`, `r yr+1` (Appendix \@ref(app:second-appendix)).  Images and information about the vessels can be found at [\underline{http://marinetraffic.com}](http://marinetraffic.com). 
...
```{r SensorText, echo=FALSE}
   ...
   sensor <-  read.csv("c:/github/surveyreport/standaloneData/methods1.csv",header=T)
  ...
  #sensor2<-  GetSQLData(sense2,"Sablefish")  # query SQL Server
   sensor2<-  read.csv("c:/github/surveyreport/standaloneData/methods2.csv",header=T)
